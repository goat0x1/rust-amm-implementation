...
use super::{
    account_meta_from_token_swap::TokenSwap,
...
mod spl_token_swap_programs {
    ...
    #[cfg(feature = "devnet")]
    pub const GOAT: Pubkey = pubkey!("HKwqLZQw1fcnnFds4nkxYAmYK67TvtZ6TnVLUMJviWPL");
...
lazy_static! {
    pub static ref SPL_TOKEN_SWAP_PROGRAMS: HashMap<Pubkey, String> = {
        ...
        m.insert(spl_token_swap_programs::GOAT, "Goat".into());
        m
    };
}
